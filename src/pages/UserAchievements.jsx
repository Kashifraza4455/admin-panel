        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 lg:gap-6 mb-6 lg:mb-8">
          ...
          <div className="bg-gradient-to-br from-amber-500/10 to-orange-500/10 rounded-xl lg:rounded-2xl p-4 lg:p-6 border border-amber-500/20">
            <div className="text-center">
              ...
              <p className="text-amber-300 text-xl lg:text-3xl font-bold">
                {totalPoints}
              </p>
              <p className="text-white/60 text-xs lg:text-sm">
                Points collected
              ...
              {achievements.map((achievement) => (
                ...
                >
                  <div className="text-center">
                    {/* Achievement Icon */}
                    <div
                      className={`text-3xl lg:text-4xl mb-3 lg:mb-4 ${
                    ...
                    {/* Level Badge */}
                    <div
                      className={`inline-block px-2 lg:px-3 py-1 rounded-full text-xs font-medium border mb-2 lg:mb-3 ${getLevelColor(
                        achievement.level
                      )}`}
                    >
                      {achievement.level}
                    ...
                    {/* Title & Description */}
                    <h3
                      className={`font-bold text-base lg:text-lg mb-1 lg:mb-2 ${
                        achievement.status === "earned"
                          ? "text-white"
                          : "text-white/60"
                      }`}
                    ...
                    <div className="flex justify-center items-center gap-2 mb-2 lg:mb-3">
                      <span className="text-yellow-400 text-base lg:text-lg">
                        ⭐
                      </span>
                      <span
              ...
              {earnedAchievements.slice(0, 3).map((achievement) => (
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:items-center gap-3 lg:gap-4">
                    ...
                    <div
                      className={`px-2 lg:px-3 py-1 rounded-full text-xs font-medium ${getLevelColor(
                        achievement.level

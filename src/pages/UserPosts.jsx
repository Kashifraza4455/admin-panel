...
export default function UserPosts() {
  ...
  if (!user)
    return <p className="p-6 text-red-500 font-semibold">User not found</p>;
    ...
    <div className="w-full space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        ...
        <div className="flex items-center gap-4">
          <div className="text-right">
            ...
            <div className="text-sm text-blue-200">Total Posts</div>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        <div className="p-4 bg-green-500/20 rounded-xl border border-green-500/30">
          ...
          <div className="text-sm text-green-200">Total Likes</div>
        </div>
        <div className="p-4 bg-blue-500/20 rounded-xl border border-blue-500/30">
          <div className="text-2xl font-bold text-blue-300">
            {userPosts.reduce((total, post) => total + post.comments, 0)}
          </div>
          <div className="text-sm text-blue-200">Total Comments</div>
        </div>
        <div className="p-4 bg-purple-500/20 rounded-xl border border-purple-500/30">
          ...
          <div className="text-sm text-purple-200">Milestones</div>
        </div>
        <div className="p-4 bg-yellow-500/20 rounded-xl border border-yellow-500/30">
          ...
          <div className="text-sm text-yellow-200">Avg Likes/Post</div>
        </div>
      </div>
      {/* Posts Grid */}
          ...
          >
            <div className="p-6">
              ...
              <div className="flex justify-between items-start mb-4">
                ...
                <span className="text-gray-400 text-sm bg-white/5 px-2 py-1 rounded">
              ...
              <div className="flex justify-between items-center pt-4 border-t border-white/10">
                ...
                <button className="text-indigo-400 hover:text-indigo-300 transition-colors font-medium text-sm flex items-center gap-1">
                  Read More
      ...
      {/* Empty State */}
      {userPosts.length === 0 && (
        <div className="text-center p-16 bg-white/5 rounded-xl border border-white/10">

          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-xl lg:rounded-2xl border border-white/20 shadow-lg p-4 lg:p-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4 lg:gap-6">
              {breathingActivities.map(activity => (
                <div key={activity.id} className="bg-gradient-to-br from-cyan-500/10 to-teal-500/10 rounded-xl lg:rounded-2xl border border-cyan-200/30 hover:border-cyan-300/50 transition-all duration-300 hover:shadow-xl p-4 lg:p-6">
                  {/* Activity Header */}
                  ...
                  <div className="space-y-2 lg:space-y-3">
                    ...
                    <div className="flex items-center justify-between p-2 bg-white/5 rounded-lg">
                      <div className="flex items-center gap-2">
                        <div className="w-6 h-6 lg:w-8 lg:h-8 bg-cyan-500/20 rounded-full flex items-center justify-center">
                          <span className="text-cyan-400 text-xs lg:text-sm">⏱️</span>
                        </div>
                        <span className="text-white text-xs lg:text-sm">Duration</span>
                      </div>
                      <span className="text-cyan-300 font-semibold text-xs lg:text-sm">{activity.duration}</span>
                    </div>
                    ...
                    <div className="flex items-center justify-between p-2 bg-white/5 rounded-lg">
                      <div className="flex items-center gap-2">
                        <div className="w-6 h-6 lg:w-8 lg:h-8 bg-teal-500/20 rounded-full flex items-center justify-center">
                          <span className="text-teal-400 text-xs lg:text-sm">🔄</span>
                        </div>
                        <span className="text-white text-xs lg:text-sm">Cycles</span>
                      </div>
                      <span className="text-teal-300 font-semibold text-xs lg:text-sm">{activity.cycles}</span>
                    </div>
                    ...
                    <div className="flex items-center justify-between p-2 bg-white/5 rounded-lg">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-white text-xs lg:text-sm">Time/Cycle</span>
                      </div>
                      <span className="text-blue-300 font-semibold text-xs lg:text-sm">{activity.timePerCycle}</span>
                    </div>
                  </div>
                </div>
              ))}
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-xl lg:rounded-2xl border border-white/20 shadow-lg p-4 lg:p-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
              <div className="text-center p-3 lg:p-4">
                ...
                <h4 className="font-semibold text-white mb-1 lg:mb-2 text-sm lg:text-base">Optimal Duration</h4>
                <p className="text-white/70 text-xs lg:text-sm">5-10 minutes daily for best results</p>
              </div>
              <div className="text-center p-3 lg:p-4">
                ...
                <h4 className="font-semibold text-white mb-1 lg:mb-2 text-sm lg:text-base">Cycle Range</h4>
                <p className="text-white/70 text-xs lg:text-sm">3-10 cycles per session recommended</p>
              </div>
              <div className="text-center p-3 lg:p-4">
                ...
                <h4 className="font-semibold text-white mb-1 lg:mb-2 text-sm lg:text-base">Consistency</h4>
                <p className="text-white/70 text-xs lg:text-sm">Daily practice brings maximum benefits</p>
              </div>
              <div className="text-center p-3 lg:p-4">
                ...
                <h4 className="font-semibold text-white mb-1 lg:mb-2 text-sm lg:text-base">Posture</h4>
                <p className="text-white/70 text-xs lg:text-sm">Sit comfortably with straight back</p>
              </div>
            </div>
          </div>
              ...
              <table className="w-full text-white min-w-[600px]">
                <thead>
                  <tr className="border-b border-white/20">
                    <th className="text-left py-2 lg:py-3 px-2 lg:px-4 font-semibold text-sm lg:text-base">Technique</th>
                    <th className="text-left py-2 lg:py-3 px-2 lg:px-4 font-semibold text-sm lg:text-base">Duration</th>
                    <th className="text-left py-2 lg:py-3 px-2 lg:px-4 font-semibold text-sm lg:text-base">Cycles</th>
                    <th className="text-left py-2 lg:py-3 px-2 lg:px-4 font-semibold text-sm lg:text-base">Time/Cycle</th>
                  </tr>
                </thead>
                <tbody>
                  {breathingActivities.map(activity => (
                    <tr key={activity.id} className="border-b border-white/10 hover:bg-white/5">
                      ...
                      <td className="py-2 lg:py-3 px-2 lg:px-4 text-sm lg:text-base">{activity.cycles}</td>
                      <td className="py-2 lg:py-3 px-2 lg:px-4 text-sm lg:text-base">{activity.timePerCycle}</td>
                    </tr>
                  ))}
                </tbody>
              </table>

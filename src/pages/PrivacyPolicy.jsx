      ...
      {!isEditing && !privacyPolicy && (
        <div className="text-center p-6 lg:p-12 bg-white/5 rounded-xl border border-white/10">
          ...
          <h3 className="text-lg lg:text-xl font-semibold text-gray-300 mb-2">
            No Privacy Policy Added
          </h3>
          <p className="text-gray-400 text-sm lg:text-base">
            Click the "Add" button to create your privacy policy
          </p>
        </div>
      )}
...
Start typing your privacy policy content..."
          ...
          <div className="mt-4 p-3 lg:p-4 bg-blue-500/10 rounded-lg border border-blue-500/20">
            <h4 className="text-blue-300 font-semibold mb-2 text-sm lg:text-base">
            ...
            <div className="text-blue-200 text-xs lg:text-sm">
              <ul className="list-disc list-inside space-y-1">
                ...
                <li>
                  <strong>Headings:</strong> H1 to H6 for section titles
                </li>
                <li>
                  <strong>Lists:</strong> Bulleted and Numbered lists
                </li>
                <li>
                  <strong>Colors:</strong> Text and background colors
                </li>
                <li>
                  <strong>Alignment:</strong> Left, Center, Right, Justify
                </li>
                <li>
                  <strong>Blocks:</strong> Quotes and code blocks
                </li>
                <li>
                  <strong>Media:</strong> Add images and links
                </li>
              </ul>
            </div>
          </div>
